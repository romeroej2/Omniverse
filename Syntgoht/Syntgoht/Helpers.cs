...
namespace Syntgoht
{
    public static class Helpers
    {
        ...
        private static async Task<bool> HelpersMethod()
        {
            ...
            //        Logger.SyntgohtLog("Handing over any item(s) in your Armory.");
